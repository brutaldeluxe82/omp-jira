...
describe("JiraToolDispatcher", () => {
	...
	it("creates an issue with direct REST fields and valid ADF", async () => {
		...
		expect(calls).toEqual([{ method: "post", path: "/rest/api/3/issue", body: { fields: { project: { key: "PROJECT" }, issuetype: { name: "Task" }, summary: "Direct API issue", description: { type: "doc", version: 1, content: [{ type: "paragraph", content: [{ type: "text", text: "Line one" }] }, { type: "paragraph", content: [{ type: "text", text: "Line two" }] }] }, priority: { id: "2" }, labels: ["platform"], parent: { key: "PROJECT-123" } } } }]);
